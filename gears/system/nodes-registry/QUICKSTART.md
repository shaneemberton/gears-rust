...
Tracks and reports information about all Gears server instances in your deployment.
...
**Use cases:**
- Monitor distributed Gears deployments
...
```bash
curl -s http://127.0.0.1:8087/cf/nodes-registry/v1/nodes | python3 -m json.tool
```
