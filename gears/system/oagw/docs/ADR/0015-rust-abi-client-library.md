...
- **Phase 0 (MVP)**: Pattern 4 (Wrapper Layer) for OpenAI + Pattern 1 (Drop-In Replacement) for internal gears + Blocking API
...
# No additional config needed - control plane injected by toolkit
