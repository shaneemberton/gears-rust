...
ALWAYS open and follow `{cf-studio-path}/requirements/artifacts-registry.md` WHEN creating/registering artifacts in `artifacts.json`
...
All Constructor Studio IDs MUST:
