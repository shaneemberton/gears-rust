...
| Check all PR statuses | **pr-status.md** | "status of all PRs", `/cf-gears-pr-status ALL` |
| Review a PR | **pr-review.md** | "review PR 123", `/cf-gears-pr-review 123` |
...
Also triggered by natural-language prompts like `cf PR status 123`.
